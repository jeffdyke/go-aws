...
require (
	...
	github.com/aws/session-manager-plugin v0.0.0-20230808183647-dbfa0bfdb04b // indirect
...
replace github.com/jeffdyke/go-aws => /src/go-aws

replace github.com/jeffdyke/go-aws/instances => /src/go-aws/instances
